            ...
            <ExperienceContent>
                ...
                <Roles>
                    <JobRoleBlock
                        ...
                        workDescription={
                            <div>
                                <p>I am currently working as a full time Software Engineering Manager for a UK consulting firm providing both technical and managerial leadership in developing full stack engineering solutions. I am responsible for:</p>
                                <ol style={{listStyleType: "disc"}}>
                                    <li>Working with the CEO, CTO, and other other engineering managers in driving policy and strategy changes within the business.</li>
